...
def part_one():
  ...
  for boarding_pass in my_input:
    row_code = boarding_pass[0:col_max]
    col_code = boarding_pass[col_max:]

    row = decode( row_code, 0, row_max, 'F', 'B' )
    col = decode( col_code, 0, col_max, 'L', 'R' )
